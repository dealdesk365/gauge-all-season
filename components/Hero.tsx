      ...
      <div className="relative z-10 px-8 max-w-5xl w-full pt-8">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              href="sms:9894709128"
              className="w-full sm:w-auto text-white font-bold text-xl px-10 py-5 rounded-xl flex items-center justify-center gap-3 hover:bg-white hover:text-gray-900 transition-colors shadow-2xl"
