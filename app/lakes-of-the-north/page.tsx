...
export const metadata: Metadata = {
  title: "Lawn Care & Snow Removal | Lakes of the North Association",
  description:
    "Gauge's All Season Services serves the Lakes of the North Association in Northern Michigan. Lawn care, spring & fall cleanups, snow blowing. Call or text for a free estimate!",
};
...
const reasons = [
  ...
  "⚡ Fast response times — we pick up the phone and show up when we say we will.",
];

export default function LakesOfTheNorthPage() {
  return (
    <main style={{ fontFamily: "sans-serif", color: "#1a1a1a" }}>
      ...
      >
        ...
        >
          Serving Lakes of the North Association
        </h1>
        <p
          style={{
            fontSize: "1.1rem",
        ...
        >
          Your trusted local yard care and snow removal service — right here in
          your community.
        </p>
      </section>
